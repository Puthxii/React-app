...
export default class Ability extends Component {
   ...
   state = {
    language: [
        ...
        {name: "JAVA", percent: "85%", color: "bg-info"},
        {name: "PHP", percent: "90%", color: "bg-info"},
        {name: "PYTHON", percent: "40%", color: "bg-danger"},
        {name: "HTML5", percent: "90%", color: "bg-info"},
        ...
        {name: "Shell-Script", percent: "0%", color: "bg-danger"}
    ]
   }
